        ...
        <div class="container">
                        ...
                        <div class="shadow bg-white p-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model.differ="full_name" id="full_name"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model.differ="phone" id="phone" class="form-control"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" wire:model.differ="email" id="email" class="form-control"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea wire:model.differ="address" id="address" class="form-control" rows="2"></textarea>
                                    @error('address')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    <h4>No items in the cart to checkout</h4>
...
@push('scripts')
    <script
        src="https://www.paypal.com/sdk/js?client-id=AfVTF3GhYO9TGFwxbGSIXqAjyzT0hU6sCzcn2CRkjjzu5SBQfvRGHSQu34_eKvGEWSNZtMeOQV8MiLvp&currency=USD">
    </script>
        ...
        paypal.Buttons({
            ...
            onApprove: (data, actions) => {
               return actions.order.capture().then(function(orderData){
                ...
                const transection = orderData.purchase_units[0].payments.captures[0];
                if(transection.status == "COMPLETED"){
                    Livewire.emit('transectionEMIT', transection.id);
