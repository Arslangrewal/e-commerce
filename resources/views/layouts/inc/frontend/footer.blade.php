            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="social-media">
                        ...
                        <a href="{{ $appSetting->facebook }}" target="blank"><i class="fa fa-facebook" ></i></a>
                        @endif
                        @if($appSetting->twitter)
                        <a href="{{ $appSetting->twitter }}" target="blank"><i class="fa fa-twitter" ></i></a>
                        @endif
                        @if($appSetting->instagram)
                        <a href="{{ $appSetting->instagram }}" target="blank"><i class="fa fa-instagram" ></i></a>
                        @endif
                        @if($appSetting->youtube)
                        <a href="{{ $appSetting->youtube }}" target="blank"><i class="fa fa-youtube" ></i></a>
                        @endif
                    </div>
                </div>
            </div>
