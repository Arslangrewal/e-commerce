            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>
                                ...
                                <a href="{{ url('admin/invoice/'.$order->id) }}" target="blank" class="btn btn-warning btn-sm float-end mx-1">
                                    view Invoice
                                </a>
                                <a href="{{ url('admin/invoice/mail/'.$order->id) }}" class="btn btn-info btn-sm float-end mx-1"> 
                                                ...
                                                <td width="10%">
                                                    ...
                                                    @if ($orderItem->product->productImages)
                                                        <img src="{{ asset($orderItem->product->productImages[0]->image) }}"
                                                            style="width: 80px; height: 70px; border-radius: 20%"
                                                            alt="">
                                                    @else
                                                        <img src=""
                                                            style="width: 80px; height: 70px; border-radius: 20%"
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <form action="{{ url('admin/orders/view/' . $order->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')

                                    <label>Update Order Status</label>
                                    <div class="input-group">
                                        <select name="order_status" id="form-select">
